...
//         // Debug.Log("[Share] Share.Start invoked, gameObject.name=" + gameObject.name + ", activeSelf=" + gameObject.activeSelf + ", activeInHierarchy=" + gameObject.activeInHierarchy);
//     }

//     void OnEnable()
//     {
//         // Debug.Log("[Share] Share.OnEnable: gameObject.activeInHierarchy=" + gameObject.activeInHierarchy);
//     }

//     void OnDisable()
//     {
//         // Debug.Log("[Share] Share.OnDisable: gameObject.activeInHierarchy=" + (gameObject != null ? gameObject.activeInHierarchy.ToString() : "destroyed"));
//     }
