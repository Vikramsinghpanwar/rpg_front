...
// public class BurstKQ : MonoBehaviour
// {
...
//                     StartCoroutine(MoveObject(myTrnasform.localPosition, destinationList[1], myTrnasform, 0));
//                 }
//                 break;
//             case 1:
//                 //dragon wins
...
//                 {
//                     Transform myTrnasform = child.GetComponent<Transform>();
//                     StartCoroutine(MoveObject(myTrnasform.localPosition, destinationList[0], myTrnasform, 0));
//                 }
//                 break;
//             case 2:
//                 //tiger wins
...
//                 {
//                     Transform myTrnasform = child.GetComponent<Transform>();
//                     StartCoroutine(MoveObject(myTrnasform.localPosition, destinationList[2], myTrnasform, 0));
//                 }
//                 break;
//         }
//     }
...
//         {
//             StartCoroutine(MoveObjectBack(child.localPosition, myPos, child));
//         }
//         coinsMoved.Clear();
...
//             StartCoroutine(MoveObject(myTrnasform.localPosition, destinationList[val], myTrnasform, val, false, false));
//         }
...
//                 {
//                     case 0:
//                         float randomX = Random.Range(-areaKQ, areaKQ);
//                         float randomY = Random.Range(randomX, areaKQ);

//                         targetPosModified = targetPos + new Vector3(randomX, randomY, 0);
//                         break;
//                     case 1:
//                         //targetPosModified = targetPos + new Vector3(Random.Range(-areaX, areaX), Random.Range(-areaY, areaY), 0);
//                         randomX = Random.Range(-areaT, areaT);
//                         if (randomX > 0)
//                         {
//                             randomY = Random.Range(-areaT, -randomX);
//                         }
//                         else
//                         {
//                             randomY = Random.Range(-areaT, randomX);
...
//                         break;
//                     case 2:
//                         randomX = Random.Range(-areaKQ, areaKQ);
//                         randomY = Random.Range(randomX, areaKQ);

//                         targetPosModified = targetPos + new Vector3(-randomX, randomY, 0);
//                         break;
//                 }
// *//*
//                 Vector3 targetPosModified = destinationList[d] + new Vector3(Random.Range(-areaKQ, areaKQ), Random.Range(-areaY, areaY), 0);
