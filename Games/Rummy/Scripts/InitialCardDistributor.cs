...
public class InitialCardDistributor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerCardsOffset = (Screen.width * 0.7f) / 13f;
        ...
        Debug.Log("poool: " + Wallet.GetPool());
    ...
    public void ClosedDeckCardRequest()
    {
        ...
        cardSprites.Add(s);
        gameDeck.Remove(s);
        newCard.transform.DOMove(mainBlock.transform.GetChild(mainBlock.transform.childCount - 1).transform.GetChild(0).transform.position, 0.3f)
           .SetEase(Ease.Linear)
           .OnComplete(() =>
           {
               newCard.transform.parent = mainBlock.transform.GetChild(mainBlock.transform.childCount - 1).transform.GetChild(0).transform;
    ...
    public IEnumerator Animate()
    {
        ...
        JokerCard.transform.DOMove(managerRef.closedDeck.transform.position + new Vector3(-100f, 30, 0), 0.3f)
            ...
            .OnComplete(() =>
            {
                JokerCard.transform.DORotate(new Vector3(0, 0, 30), 0.3f)
                .SetEase(Ease.Linear);
          ...
          .OnComplete(() =>
          {
              ...
              CheckForJoker();
              gameDeck.Remove(spriteK); JokerCard.transform.DOScaleX(1.3f, 0.3f)
          .SetEase(Ease.Linear)
          .OnComplete(() =>
          {
            ...
            .SetEase(Ease.Linear);
              ...
              .OnComplete(() =>
              {
                  ...
                  JokerCardUpdate();
                  managerRef.gameCoroutine = StartCoroutine(managerRef.GameEnum());
    ...
    public void AddCardToOpenDeckbyP2()
    {
        ...
        if (managerRef.roundCount > finishAfterRound && sn == 0)
        {
    ...
    public void AddCardToOpenDeckbyP3()
    {
        managerRef.connectionRef.cardSound.Play();
        int sn = Random.Range(0, 2);
        ...
        else
        {
            ...
            GameObject newCard = Instantiate(cardPrefab, managerRef.player3.transform);
            newCard.transform.localScale = new Vector3(1.3f, 1.3f, 1.3f);
    ...
    public void AddCardToOpenDeckbyP4()
    {
        managerRef.connectionRef.cardSound.Play();
        int sn = Random.Range(0, 2);
        if (managerRef.roundCount > finishAfterRound && sn == 1)
        ...
        else
        {
            ...
            GameObject newCard = Instantiate(cardPrefab, managerRef.player4.transform);
            newCard.transform.localScale = new Vector3(1.3f, 1.3f, 1.3f);
    ...
    public void AddCardToOpenDeckbyP5()
    {
        managerRef.connectionRef.cardSound.Play();
        int sn = Random.Range(0, 2);
        if (managerRef.roundCount > finishAfterRound && sn == 1)
        ...
        else
        {
            ...
            GameObject newCard = Instantiate(cardPrefab, managerRef.player5.transform);
            newCard.transform.localScale = new Vector3(1.3f, 1.3f, 1.3f);
    ...
    public void AddCardToOpenDeckbyP6()
    {
        managerRef.connectionRef.cardSound.Play();
        int sn = Random.Range(0, 2);
        if (managerRef.roundCount > finishAfterRound && sn == 1)
        ...
        else
        {
            ...
            GameObject newCard = Instantiate(cardPrefab, managerRef.player6.transform);
            newCard.transform.localScale = new Vector3(1.3f, 1.3f, 1.3f);
