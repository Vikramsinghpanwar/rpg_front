...
// public class BurstDT : MonoBehaviour
// {
...
//             StartCoroutine(MoveObject(myTrnasform.localPosition, destinationList[val].localPosition, myTrnasform, 0, false, false));
//         }
...
//                     break;
//                 }
//                 int d = Random.Range(0, destinationList.Length);
//                 int c_num = Random.Range(0, coinsToMoveList.Count);
//                 Vector3 targetPosModified = destinationList[d].localPosition + new Vector3(Random.Range(-area, area), Random.Range(-areaY, areaY), 0);
...
//                 break;
//             }
//             d = Random.Range(0, destinationList.Length);
//             c_num = Random.Range(0, coinsToMoveList.Count);

//             StartCoroutine(MoveObject(myPos, destinationList[d].localPosition, coinsToMoveList[c_num], d));
//             coinsMoved.Add(coinsToMoveList[c_num].gameObject);
//             coinsToMoveList.RemoveAt(c_num);
